...
**The data credit** (`src/ui/attribution.ts`) — read from the artefacts and carried in the footer of every screen, folded since 14 September under *Data sources · Licensing · Not a flood warning*. CC BY 4.0 requires the attribution to be visible to the person using the work, which one press still makes it, and it includes the clause people skip: an indication that changes were made.
