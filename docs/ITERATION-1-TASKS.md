...
| ≥90% coverage on judgement-carrying modules, ≥88% overall, suite under 5 s | Every pull request | 92.8% Node · 91.05% Python. **Node 3.6 s ✓, Python 105 s ✗** — both timed as CI runs them |
