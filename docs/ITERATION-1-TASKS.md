...
| ≥90% coverage on judgement-carrying modules, ≥88% overall, suite under 5 s | Every pull request | 92.8% Node · 91.05% Python. **Node ≈ 5 s on the runner — at the limit · Python 66 s ✗**. Locally 3.6 s and 105 s |
